...
async function toImageRequireNode(node, imagePath, filePath) {
    ...
    const hash = (_a = parsedUrl.hash) !== null && _a !== void 0 ? _a : '';
    const search = (_b = parsedUrl.search) !== null && _b !== void 0 ? _b : '';
    ...
    try {
        ...
        logger_1.default.error `The image at path=${imagePath} can't be read correctly. Please ensure it's a valid image.
${e.message}`;
    }
...
const plugin = (options) => {
    const transformer = async (root, vfile) => {
        const promises = [];
